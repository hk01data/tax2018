  ...
  methods: {
    ...
    get_rate () { // onday_onday(6)
      ...
      if (this.AssessYear === '2019-2020') {
        ...
        this.TAX_RANGE[4] = 50000 // 50000 MOCK 40000, 60000
        ...
        this.TAX_RATE_R = 17
        this.TAX[0] = 0
        // this.TAX[1] = 1200 // 1000 MOCK 1200
        // this.TAX[2] = 4800 // 4000 MOCK 4800
        // this.TAX[3] = 10800 // 9000 MOCK 9450
        // this.TAX[4] = 19200
    ...
    get_deduction () { // onday_onday(7)
      ...
      if (YrValue === '2019-2020') {
        ...
        this.LimD_Elderly = 100000 // 100000 MOCK 120000
